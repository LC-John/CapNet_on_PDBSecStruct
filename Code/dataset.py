...
def dirty_data(clean_path = "../Dataset/final_m.pkl.gz",
               dirty_path = "../Dataset/final_m_tr.pkl.gz", dirty_ratio = 1.,
               final_path = "../Dataset/dirty_m.pkl.gz"):
